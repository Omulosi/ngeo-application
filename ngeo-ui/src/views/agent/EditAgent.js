...
const EditAgent = () => {
  ...
  return (
    <Page className={classes.root} title={`Edit ${siteNames.Agent.name}`}>
      <Container maxWidth={false}>
        <DataGridToolbar pageTitle={`Edit ${siteNames.Agent.name}`} />
        <Box>
          <form
            autoComplete="off"
            noValidate
          ...
          >
            <Card>
              <CardHeader title={`Edit ${siteNames.Agent.name} info`} />
              <Divider />
              <CardContent>
